...
with col1:
    st.image("https://upload.wikimedia.org/wikipedia/commons/a/a8/Iris_setosa_cultivar_3.JPG", caption="Iris Setosa (Placeholder Image)", caption="Iris Setosa", use_container_width=True)
